...
#define STEER_RATION 16.2   //转向传动比
#define STEER_DEVIATION 0.123457 //主动加了一个偏差
#define WEIGHT_COEFFICIENT 0.1
#define ANGLE_BASE  740     //三个包对应的前轮转角的的初始值
#define GACU_ANGLE_BASE 4000.0 //gacu的前轮转角
...
typedef struct ACU_Can_Feedback {
    ...
    uint8_t drive_fault:2;      //这是故障检测位, 直接设置为0
